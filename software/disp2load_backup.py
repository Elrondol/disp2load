...
def inversion_steepest(G,Us,lamb,Cm1,rs,maxit,source_number,data_number,sig=None):
...
def inversion_nlcg(G,Us,lamb,Cm1,rs,maxit,source_number,sig=None):
    print('tbd')
    return None 

def inversion_CG_scipy(G,Us,lamb,Cm1,rs,maxit,source_number,sig=None):
    print('tbd')
    return None
