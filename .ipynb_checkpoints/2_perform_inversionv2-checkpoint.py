...
epsilon=1e-35
maxit = 2e2
Cm1 = np.load('/home/parisnic/project/disp2load/gaussian_0.01.npy') #'gaussian' or 'laplacian' to compute, but we can precompute it to save time
sigma =  0.01 #penser à use 
lambs = np.logspace(-4,9,60)
