...
lines_to_compute = range(0,10) # (premiere ligne de sources calculée, dernière ligne calculée )
...
xs = np.linspace(-500, 500, 100)  #nested loops -> il calcule la grille complète
